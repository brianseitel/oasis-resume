function xkcdplot(options) {
    ...
    var width = options.width,
        ...
        arrowAspect = options.arrowAspect,
    ...
    xkcd.draw = function () {
        // Set the axes limits.
        xscale.domain([0, 35]).range([0, width]);
        yscale.domain([0, 80]).range([height, 0]);
        ...
        el.append("text").attr("class", "title")
                              ...
                              .attr("y", 0)
                              .text(title);
        el.append("text").attr("class", "datapoint label")
